...
def run_boosfetch():
    ...
    # Read boos_version directly passed by BoosOS kernel execution context
    os_ver = boos_version if 'boos_version' in globals() else "Unknown"
    ...
    info = [
        ...
        f"{C_CYAN}----------------------------------{C_RESET}",
        f"{C_BOLD}{C_YELLOW}OS         :{C_RESET} BoosOS v{os_ver}",
